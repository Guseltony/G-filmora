    ...
    <div className='mt-16 md:mt-24 '>
        {
            ...
            <div className='w-[96%] mb-4 md:mb-8 md:w-[700px] h-fit ml-0 md:ml-[5%] bg-black/50 md:bg-black/30 backdrop-blur-lg px-4 md:px-6 rounded-xl md:py-6 py-4 shadow-lg border-1 border-amber-200 '>
                ...
                <p className='text-xs md:text-base text-[#e00000] md:text-[#CCFF00] mb-2 font-semibold underline'>Release: { movies.release_date }</p>
