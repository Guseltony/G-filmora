...
return (
    <div>
        <button className='relative flex flex-row gap-4 items-center justify-center px-4 py-2 group overflow-hidden hover:border-[#ad16a1] duration-500 cursor-pointer md:h-14 md:w-48 w-40 h-12 bg-[#10b981]/[0.10] rounded-4xl'>
